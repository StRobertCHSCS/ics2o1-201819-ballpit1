...
kelvin = arcade.load_texture("Screenshot-20181016-190732.PNG")
kristen = arcade.load_texture("IMG-2607.JPG")
...
def on_draw():
    ...
    arcade.draw_text("Score: "+str(score), 100, 50, arcade.color.BLACK)

    if dead:
        arcade.set_background_color(arcade.color.RED)
        arcade.draw_text("You died, your score is shit " + str(score), 100, HEIGHT - 100, arcade.color.BLACK, 30)
        now = time.time()
